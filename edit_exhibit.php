	...
	<div class='container'>
		<div class='row'>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="panel panel-primary">
					  ...
					  <div class="panel-body">
		          <div class="form-group">
						  	<textarea class="form-control" rows="8" name="company_profile" placeholder="Tell us about yourself"><?= $exhibitDetails['company_profile'] ?></textarea>
		          </div>
					  </div>
					</div>
				</div>
				...
				<div class="col-lg-6">
					<div class="panel panel-primary">
					  ...
					  <div class="panel-body">
		          <div class="form-group">
						  	<textarea class="form-control" rows="8" name="special_requests" placeholder="Tell us about yourself"><?= $exhibitDetails['special_requests'] ?></textarea>
		          </div>
					  </div>
					</div>
				</div>
			...
			<div class="row text-center">
				...
				<a href="edit_exhibit.php?id=<?=$exhibitId?>" class="btn btn-lg btn-danger" disabled>Edit</a>
			</div><!-- /.row -->
		</form>
			</div>
		</div>
