...
echo "
<form name='adminPermission' action='".$_SERVER['PHP_SELF']."?id=".$permissionId."' method='post' class='forms'>

<div class='col-33'>
<h3>Permission Information</h3>
<label>ID: ".$permissionDetails['id']."</label>

<label>Name <input type='text' name='name' value='".$permissionDetails['name']."' /></label>
