...
if (isset($_POST['newPresentation'])) {
	...
	if ($presentation_title = "") {
		$errors[] = lang("PRESENTATION_NO_TITLE");
	}
	
	if ($presentation_abstract = "") {
		$errors[] = lang("PRESENTATION_NO_ABSTRACT");
	}
	
	if ($presenter_bio = "") {
		$errors[] = lang("PRESENTER_NO_BIO");
	}
	
	if (!count($errors)) {
		//Construct a user object if there are no errors
