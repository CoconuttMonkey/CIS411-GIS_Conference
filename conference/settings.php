...
<body>
	...
	<section class="container">
		...
		<div class='row'>
				<form name='conf_settings' id="conf_settings" action='<? echo $_SERVER['PHP_SELF']; ?>' method='post' class='forms' enctype="multipart/form-data">
					<? if (isset($_GET['new'])) {?><input type="text" name="newConference" value="1" style="display:none;" /><?} ?>
							...
							<div class="panel panel-primary">
							  ...
							  <div class="panel-body">
									<div class="form-group">
									  ...
									  <input type='text' name='title' class="form-control" value="<? echo $conferenceData['title']; ?>" required />
									</div>
	                    ...
	                    <div class="input-group date" id="conf_start">
	                        <input type="text" class="form-control" name="conf_start" required />
	                    ...
	                    <div class="input-group date" id="conf_end">
	                        <input type="text" class="form-control" name="conf_end" required />
	                        <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
	                    </div>
	                  </div>
									</div>
	                    ...
	                    <div class="input-group date" id="reg_open">
	                        <input type="text" class="form-control" name="reg_open" required />
	                        <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
	                    </div>
	                  </div>
	                    ...
	                    <div class="input-group date" id="reg_close">
	                        <input type="text" class="form-control" name="reg_close" required />
	                        <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
	                    </div>
	                  </div>
									</div>
									...
									<div class="form-group">
									  ...
									  <textarea class="form-control" rows="5" id="abstract" name="abstract" required></textarea>
									</div>
