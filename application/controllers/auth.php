...
class Auth extends CI_Controller {
  ...
  function __construct() 
  {
	...
	/**
	 * Many of the functions within this controller load a custom model called 'demo_flexi_auth_model' that has been created for the purposes of this demo.
	 * The 'demo_flexi_auth_model' file is not part of the flexi auth library, it is included to demonstrate how some of the functions of flexi auth can be used.
	 *
	...
	*/
    ...
    {	
		...
		if ($this->flexi_auth->ip_login_attempts_exceeded())
		{
			 ...
			 * 
			 * Note: To use this example, you will also need to enable the recaptcha examples in 'models/demo_flexi_auth_model.php', and 'views/login_view.php'.
			*/
			 ...
			 *
			 * Note: To use this example, you will also need to enable the math_captcha examples in 'models/demo_flexi_auth_model.php', and 'views/login_view.php'.
			*/
