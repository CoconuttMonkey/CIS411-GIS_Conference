 ...
 */
$config['site_title']                 = "NW PA GIS Conference";       // Site Title, example.com
$config['admin_email']                = "gisconference@clarion.edu"; // Admin Email, admin@example.com
...
$config['message_start_delimiter'] = '<p class="alert alert-info alert-dismissible">'; 	// Message start delimiter
$config['message_end_delimiter']   = '</p>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<div class="alert alert-danger alert-dismissible" role="alert">';		// Error mesage start delimiter
